...
-Здесь тестировщик проверяет соответствие элементов страницы дизайнерскому макету и их размеры. Это может включать проверку расположения, шрифтов, цветов, отступов и т.д. в соответствии с заданными дизайн-макетами.
Нет конкретных ссылок, так как это общие практики тестирования пользовательского интерфейса (UI).

у вас есть форма для логина в систему пользователя в которой есть поля, согласно спецификации размер полей строго установлен вы проверяете так ли это, например, поле 16 пикселей, если это так то всё хорошо, процесс верификации пройден
___
