...
OSI (Open Systems Interconnection) – это модель состоящая из набора правил, созданная для обмена данными между различными устройствами в сети , состоящая из 7 уровней 
...
физический уровень позволяет переносить данные, его задача - передача битов(0 и 1). всё что способствует перемещению с одного пк на другой относится к технологиям первого уровня - кабель, wifi, bluetoth, ик-порт
