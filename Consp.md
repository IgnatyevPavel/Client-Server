...
___
### 99. что такое cashe
- это временное хранилище на компьютере или устройстве пользователя, в котором хранятся копий веб-страниц, изображений, таблиц стилей и других ресурсов, которые были загружены ранее при посещении веб-сайтов. нужно для ускорения загрузки веб-страниц и снижения нагрузки на сервер.

### 99. что такое cookies
- это файлы создаваемые веб сайтами котоыре посещает юзер. в ней хранится информация об вашей атентификации, о предпочтениях и настройках юзера.
