...
верификация проводится только на сервере, так как если проводить верификацию на клиенте это не безопасно.
___
...
### 24. что такое Валидация

валидация на клиенте и на сервере проверяет правильность данных
...
___
### 26 верификация на клиенте

### 26 верификация на сервере 
___
