...
-это структура веб сайта, с помощью html мы распределяем элементы сайта.
...
**CSS** (Cascading Style Sheets) - каскадная таблица стилей.- с помощью css можно стилизовать веб-сайт. технология которая используется при создании сайтов. css это стилизация веб сайта, он появился позже чем html и использоваться он стал намного позже. css отделяет описание структуры документа html от стилизации документа. потому что со временем веб-сайты становились всё сложнее и сложнее и если вы прописывали стили элементов в одном только html то это было очень-очень сложно поддерживать, сложно было вносить изменения и в принципе кода было очень много и уже хотелись бы как то его структурировать. css пришёл на помощь, с его помощью удалось отделить стилизацию сайта от его структуры. с помощью css можно сделать много всего с веб сайтом. изменять цвета текстов, цвета элементов. с помощью css можно поменять порядок размещения элементов на веб сайте который изначально был сделан на html. можно прописать шрифты, кастомизировать картинка, элементы, менять размеры, менять их границы, можно добавлять тень, эффекты. так же в css можно создавать анимации и в принципе css постоянно развивается, если раньше какие то вези для элементов на веб сайте можно было сделать с помощью javascript/ можно уже сделать с помощью css/ css делает сайт более красивым, он его оживляет, делает интерактивным. и веб сайты построенные на html проигрывают в плане внешнего вида тем веб сайтам которые используют css  





используется для задания внешнего вида веб-страницы, такого как цвета, шрифты, расположение элементов и т. д. CSS позволяет разработчикам легко изменять стиль и внешний вид веб-страницы без изменения ее структуры.
