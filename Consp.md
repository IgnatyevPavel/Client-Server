...
-делаем ли мы продукт правильно? соответствует ли он спецификации??
-как рабочий софт соответствует установленным требованиям?
=проверка того что мы делаем ПО првильно, у нас есть внятная документация, есть дизайны, настроенные процессы тестирования(тестирование без запуска кода, статическое тестирование, тестирование документации, дизайна, процессов и тд, верификация идёт перед валидацией) это поиск багов заранее, чтобы эти баги не воспроизвелись в написанном софте 
