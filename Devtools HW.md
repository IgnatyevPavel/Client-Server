# Devtools HW ![Browser](https://img.shields.io/badge/Google_Chrome-117.0.5938.149-4285F4) ![Editor](https://img.shields.io/badge/VScode-1.81.1-0071bc)
...
6. Выбрать Responsive - Mobile - указать любое устройство
7. Продемонстрировать работу дизайна Responsive
8. Выставить Dimensions: Adaptive (select device). выбрать любой девайс
9. Создать свой девайс. Motorola razr v3 экран - 96×80
...
+ Они не отобразились на сайте, поэтому мы можем создать свои для примера:
